  ...
  "short-blanks": {
    ...
    reviewFrames: [
      reviewFrame(
        4.25,
        "no-blank-baseline",
        "Uninterrupted compact handoff at the cue timestamp.",
      ),
      reviewFrame(
        6.05,
        "100ms-blank-entry",
        "The short Intentional Blank starts at its own timestamp.",
      ),
      reviewFrame(
        6.35,
        "100ms-blank",
        "Lyrics return during the unfinished 100 ms blank departure.",
      ),
      reviewFrame(
        8.15,
        "300ms-blank-entry",
        "The current cue departs before the next cue activates.",
      ),
      reviewFrame(
        8.55,
        "300ms-blank",
        "Lyrics return during the unfinished 300 ms blank departure.",
      ),
      reviewFrame(
        10.45,
        "500ms-blank-settled",
        "The longer departure settles before lyrics return.",
      ),
      reviewFrame(
        10.75,
        "500ms-blank",
        "Lyrics return after the 500 ms blank settles.",
      ),
      reviewFrame(
        15.05,
      ...
      reviewFrame(
        ...
        "The returning cue lifts out of the longer blank at its timestamp.",
      ),
      reviewFrame(
        21.5,
        "single-final-exit",
  ...
  "blank-lifecycle": {
    ...
    reviewFrames: [
      ...
      reviewFrame(
        7.25,
        "return-out-of-blank",
        "Lyrics return at their cue timestamp after a seek into the internal blank.",
      ),
      reviewFrame(
        12.8,
  ...
  "wrapping-progression": {
    ...
    reviewFrames: [
      ...
      reviewFrame(
        2.25,
        "one-line-cue-entry",
        "First cue rises after composition preparation.",
      ),
      reviewFrame(
        2.7,
      ...
      reviewFrame(5.1, "longer-cue-settled", "Wrapping cue hierarchy settled."),
      reviewFrame(
        5.91,
